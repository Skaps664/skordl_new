...
export default function Header({ scrollY, activeSection, isMenuOpen, setIsMenuOpen }: HeaderProps) {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 px-4 py-4 md:py-6 transition-all duration-300 ${scrollY > 50 ? "bg-black/90 dark:bg-black/90 backdrop-blur-sm" : "bg-transparent"
        }`}
    >
